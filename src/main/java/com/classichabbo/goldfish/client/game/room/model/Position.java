...
public class Position {
    ...
    /**
     * Cords to create list of coordinates for a flat circle
    ...
    public void override(Position newPosition) {
        this.X = newPosition.getX();
        this.Y = newPosition.getY();
        this.Z = newPosition.getZ();
        this.headRotation = newPosition.getHeadRotation();
        this.bodyRotation = newPosition.getBodyRotation();
    }
