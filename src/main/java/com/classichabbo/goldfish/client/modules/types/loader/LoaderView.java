...
public class LoaderView extends View {
    ...
    public void start() {
        ...
        this.loadingLogoImage.setImage(ResourceManager.getInstance().getFxImage("assets/views/loader", "logo.png"));
        this.getChildren().add(this.loadingLogoImage);

        this.loaderBarImage = new ImageView();
        this.loaderBarImage.setImage(ResourceManager.getInstance().getFxImage("assets/views/loader", "loader_bar_0.png"));
