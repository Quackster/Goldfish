...
public class NavigatorItem extends Pane {
    ...
    private void applyRoom() {
        ...
        this.goButton.setBackground(new Background(new BackgroundImage(ResourceManager.getInstance().getFxImage("assets/views/navigator", "go_" + this.backgroundImg + ".png"), BackgroundRepeat.REPEAT, BackgroundRepeat.NO_REPEAT, BackgroundPosition.DEFAULT, BackgroundSize.DEFAULT)));
    ...
    public void applyCategory() {
        ...
        this.setBackground(new Background(new BackgroundImage(ResourceManager.getInstance().getFxImage("assets/views/navigator", "category_" + this.backgroundImg + ".png"), BackgroundRepeat.REPEAT, BackgroundRepeat.NO_REPEAT, BackgroundPosition.DEFAULT, BackgroundSize.DEFAULT)));
    }
